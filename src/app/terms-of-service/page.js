			...
			<div data-custom-class="body">
				...
				<div align="center" style={{ textAlign: "left" }}>
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							<bdt className="block-component" /> (
							<bdt className="block-component" />"<strong>Company</strong>," "<strong>we</strong>," "<strong>us</strong>
							," "<strong>our</strong>"
							<bdt className="statement-end-if-in-editor" />)
							<span
								style={{
				...
				<div align="center" style={{ textAlign: "left" }}>
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							<span style={{ color: "rgb(0, 58, 250)" }}>
								<bdt className="question">melocue.com</bdt>
							</span>{" "}
							(the <bdt className="block-component" />"<strong>Site</strong>"
							<bdt className="statement-end-if-in-editor" />)
							<bdt className="block-component" />
							<bdt className="block-component" />, as well as any other related products and services that refer or link
							to these legal terms (the <bdt className="block-component" />"<strong>Legal Terms</strong>"
							<bdt className="statement-end-if-in-editor" />) (collectively, the <bdt className="block-component" />"
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							phone at <bdt className="question">239 878 7268</bdt>, email at{" "}
							<bdt className="question">melocue@gmail.com</bdt>
							<bdt className="block-component" />,
							<bdt className="statement-end-if-in-editor" /> or by mail to{" "}
							<bdt className="question">1710 SE 21st St</bdt>
							<bdt className="block-component" />, <bdt className="question">Cape Coral</bdt>
							<bdt className="block-component" />
							<bdt className="block-component" />, <bdt className="question">FL</bdt>
							<bdt className="statement-end-if-in-editor" />
							<bdt className="block-component" />
							<bdt className="block-component" /> <bdt className="question">33990</bdt>
							<bdt className="statement-end-if-in-editor" />
							<bdt className="block-component" />
							<bdt className="block-component">,&nbsp;</bdt>
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							<bdt className="statement-end-if-in-editor" />
							), and <bdt className="question">JC&X SOLUTIONS LLC</bdt>, concerning your access to and use of the
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							changes or modifications to these Legal Terms <bdt className="block-component" />
							at any time and for any reason
							<bdt className="statement-end-if-in-editor" />. We will alert you about any changes by updating the{" "}
							<bdt className="block-component" />
							"Last updated"
							<bdt className="statement-end-if-in-editor" /> date of these Legal Terms, and you waive any right to
				...
				<div align="center" style={{ textAlign: "left" }}>
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						...
						<a data-custom-class="link" href="#software" /> <a data-custom-class="link" href="#software" />
					</div>
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						...
						<a data-custom-class="link" href="#copyrightyes">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">17. COPYRIGHT INFRINGEMENTS</span>
							</span>
						</a>
						<span style={{ fontSize: 15 }}>
							<span data-custom-class="body_text">
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#terms">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">18. TERM AND TERMINATION</span>
							</span>
						</a>{" "}
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#modifications">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">19. MODIFICATIONS AND INTERRUPTIONS</span>
							</span>
						</a>{" "}
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#law">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">20. GOVERNING LAW</span>
							</span>
						</a>{" "}
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#disputes">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">21. DISPUTE RESOLUTION</span>
							</span>
						</a>{" "}
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#corrections">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">22. CORRECTIONS</span>
							</span>
						</a>{" "}
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#disclaimer">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">23. DISCLAIMER</span>
							</span>
						</a>{" "}
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#liability">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">24. LIMITATIONS OF LIABILITY</span>
							</span>
						</a>{" "}
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#indemnification">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">25. INDEMNIFICATION</span>
							</span>
						</a>{" "}
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#userdata">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">26. USER DATA</span>
							</span>
						</a>{" "}
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#electronic">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">27. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</span>
							</span>
						</a>{" "}
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#misc">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">29. MISCELLANEOUS</span>
							</span>
						</a>{" "}
					...
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<a data-custom-class="link" href="#contact">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
								<span data-custom-class="body_text">30. CONTACT US</span>
							</span>
						</a>
					</div>
				</div>
				...
				<div align="center" style={{ textAlign: "left" }}>
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							The Content and Marks are provided in or through the Services <bdt className="block-component" />
							"AS IS"
							<bdt className="statement-end-if-in-editor" /> for your <bdt className="block-component" />
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						<span style={{ fontSize: 15 }}>
							Subject to your compliance with these Legal Terms, including the <bdt className="block-component" />"
							<bdt className="statement-end-if-in-editor" />
						</span>
						<a data-custom-class="link" href="#prohibited">
							<span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>PROHIBITED ACTIVITIES</span>
						</a>
						<span style={{ fontSize: 15 }}>
							<bdt className="block-component" />"
							<bdt className="statement-end-if-in-editor" /> section below, we grant you a non-exclusive,
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							<bdt className="question">melocue@gmail.com</bdt>. If we ever grant you the permission to post, reproduce,
							or publicly display any part of our Services or Content, you must identify us as the owners or licensors
				...
				<div align="center" style={{ textAlign: "left" }}>
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						<span style={{ fontSize: 15 }}>
							...
							<bdt className="block-component" />"
							<bdt className="statement-end-if-in-editor" /> section carefully prior to using our Services to understand
							the (a) rights you give us and (b) obligations you have when you post or upload any content through the
							Services.
						</span>
					</div>
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						<span style={{ fontSize: 15 }}>
							...
							other information about the Services (<bdt className="block-component" />
							"Submissions"
							<bdt className="statement-end-if-in-editor" />
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						<span style={{ fontSize: 15 }}>
							...
							<bdt className="block-component" /> and possibly through third-party websites
							<bdt className="statement-end-if-in-editor" />.
						</span>
					</div>
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						<span style={{ fontSize: 15 }}>
							<strong>
								When you post Contributions, you grant us a <bdt className="block-component" />
								license
								<bdt className="statement-end-if-in-editor" /> (including use of your name, trademarks, and
								logos):&nbsp;
							</strong>
							...
							<bdt className="block-component" />
							license
							<bdt className="statement-end-if-in-editor" /> to: use, copy, reproduce, distribute, sell, resell,
							...
							incorporate into other works, your Contributions, and to <bdt className="block-component" />
							sublicense the licenses
							<bdt className="statement-end-if-in-editor" /> granted in this section. Our use and distribution may occur
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						<span style={{ fontSize: 15 }}>
							...
							license
							<bdt className="statement-end-if-in-editor" /> includes our use of your name, company name, and franchise
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						<span style={{ fontSize: 15 }}>
							...
							<bdt className="statement-end-if-in-editor" /> through any part of the Services
							<bdt className="block-component" /> or making Contributions accessible through the Services by linking
					...
					<ul>
						<li className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
							...
							<span style={{ fontSize: 15 }}>
								<bdt className="block-component" />"
								<bdt className="statement-end-if-in-editor" /> and will not post, send, publish, upload, or transmit
								through the Services any Submission
								<bdt className="block-component" /> nor post any Contribution
								<bdt className="statement-end-if-in-editor" /> that is illegal, harassing, hateful, harmful, defamatory,
						...
						<li className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
							<span style={{ fontSize: 15 }}>
								...
								<bdt className="statement-end-if-in-editor" /> are original to you or that you have the necessary rights
								and <bdt className="block-component" />
								licenses
								<bdt className="statement-end-if-in-editor" /> to submit such Submissions
								<bdt className="block-component" /> and/or Contributions
								<bdt className="statement-end-if-in-editor" /> and that you have full authority to grant us the
						...
						<li className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
							<span style={{ fontSize: 15 }}>
								...
								<bdt className="block-component" /> and/or Contributions
								<bdt className="statement-end-if-in-editor" /> do not constitute confidential information.
							</span>
						</li>
					</ul>
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						<bdt className="block-component" /> and/or Contributions
						<bdt className="statement-end-if-in-editor" /> and you expressly agree to reimburse us for any and all
				...
				<div align="center" style={{ textAlign: "left" }}>
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						<bdt className="block-container if" data-type="if" id="8d4c883b-bc2c-f0b4-da3e-6d0ee51aca13">
							...
							<span style={{ color: "rgb(89, 89, 89)", fontSize: "11pt" }}>
								) you will not use the Services for any illegal or <bdt className="block-component" />
								unauthorized
				...
				<div align="center" style={{ textAlign: "left" }}>
					<div className="MsoNormal" style={{ textAlign: "justify", lineHeight: "115%" }}>
						...
						<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
							...
							<span style={{ fontSize: 15 }}>
								We make every effort to display as accurately as possible the <bdt className="block-component" />
								colors
								<bdt className="statement-end-if-in-editor" />, features, specifications, and details of the products
								available on the Services. However, we do not guarantee that the <bdt className="block-component" />
								colors
								<bdt className="statement-end-if-in-editor" />, features, specifications, and details of the products
								will be accurate, complete, reliable, current, or free of other errors, and your electronic display may
								not accurately reflect the actual <bdt className="block-component" />
								colors
								<bdt className="statement-end-if-in-editor" /> and details of the products.{" "}
								<bdt className="statement-end-if-in-editor" />
								All products are subject to availability
								<bdt className="block-component" />, and we cannot guarantee that items will be in stock
								<bdt className="statement-end-if-in-editor" />. We reserve the right to discontinue any products at any
				...
				<div align="center" style={{ textAlign: "left" }}>
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", marginLeft: 20 }}>
						<span
							style={{
								fontSize: "11.0pt",
								lineHeight: "115%",
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We
				...
				<div align="center" style={{ textAlign: "left" }}>
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							fees, and you <bdt className="block-component" />
							authorize
							<bdt className="statement-end-if-in-editor" /> us to charge your chosen payment provider for any such
				...
				<div align="center" style={{ textAlign: "left" }}>
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							judgment
							<bdt className="statement-end-if-in-editor" />, appear to be placed by dealers, resellers, or
							distributors.
						</span>
						<span
							style={{
						...
						>
							<bdt data-type="conditional-block" style={{ color: "rgb(10, 54, 90)", textAlign: "left" }}>
								<bdt
					...
					<div className="MsoNormal" data-custom-class="heading_1" id="returnno" style={{ lineHeight: "1.5" }}>
						<strong>
							<span style={{ fontSize: 19 }}>
								7. <bdt className="block-component" />
								RETURN/REFUNDS
					...
					<div className="MsoNormal" style={{ textAlign: "justify", lineHeight: 1 }}>
						<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
							...
							>
								...
								<bdt className="block-component" />
								endeavors
								<bdt className="statement-end-if-in-editor" /> except those that are specifically endorsed or approved
								by us.
							</span>
						</div>
					</div>
												...
												>
													...
													>
														...
														>
															...
															unauthorized
															<bdt className="statement-end-if-in-editor" /> framing of or linking to the Services.
														</span>
													</span>
												</span>
											</span>
												...
												>
													...
													>
														...
														>
															...
															use or launch any <bdt className="block-component" />
															unauthorized
															<bdt className="statement-end-if-in-editor" /> script or other software.
														</span>
													</span>
												</span>
											</span>
												...
												>
													...
													>
														...
														>
															...
															unauthorized
															<bdt className="statement-end-if-in-editor" /> use of the Services, including collecting
												...
												>
													...
													>
														...
														>
															...
															and/or the Content for any revenue-generating <bdt className="block-component" />
															endeavor
															<bdt className="statement-end-if-in-editor" /> or commercial enterprise.
														</span>
														<span
															style={{
																fontSize: "11pt",
										...
										<bdt data-type="body">
											<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
												...
												>
													...
													non-proprietary. When you create or make available any Contributions, you thereby represent
													and warrant that:
													<bdt className="else-block">
														<bdt className="block-component" />
													</bdt>
							...
							<ul style={{ fontSize: "medium", textAlign: "left" }}>
								...
								<li data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
									<span style={{ color: "rgb(89, 89, 89)" }}>
										<span style={{ fontSize: 14 }}>
											<span data-custom-class="body_text">
												You are the creator and owner of or have the necessary <bdt className="block-component" />
												licenses
												<bdt className="statement-end-if-in-editor" />, rights, consents, releases, and permissions to
												use and to <bdt className="block-component" />
												authorize
												<bdt className="statement-end-if-in-editor" /> us, the Services, and other users of the Services
								...
								<li data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
									<span style={{ color: "rgb(89, 89, 89)" }}>
										<span style={{ fontSize: 14 }}>
											<span data-custom-class="body_text">
												Your Contributions are not unsolicited or <bdt className="block-component" />
												unauthorized
												<bdt className="statement-end-if-in-editor" /> advertising, promotional materials, pyramid
									...
									<span style={{ color: "rgb(89, 89, 89)" }}>
										<span style={{ fontSize: 14 }}>
											<span data-custom-class="body_text">
												...
												<bdt className="block-component" />
												libelous
												<bdt className="statement-end-if-in-editor" />, slanderous, or otherwise objectionable (as
												determined by us).
											</span>
										</span>
									</span>
										...
										>
											...
											<bdt className="block-container if" data-type="if" id="19652acc-9a2a-5ffe-6189-9474402fa6cc">
												<bdt data-type="conditional-block">
													...
													/>
													<bdt data-type="body">
														&nbsp;or making Contributions accessible to the Services by linking your account from the
											...
											license
											<bdt className="statement-end-if-in-editor" /> to host, use, copy, reproduce, disclose, sell,
											...
											<bdt className="statement-end-if-in-editor" /> of the foregoing. The use and distribution may
								...
								<bdt data-type="body">
									<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
										...
										>
											This <bdt className="block-component" />
											license
											<bdt className="statement-end-if-in-editor" /> will apply to any form, media, or technology now
								...
								<bdt data-type="body">
									<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
										...
										>
											...
											any Contributions; (2) to <bdt className="block-component" />
											re-categorize
											<bdt className="statement-end-if-in-editor" /> any Contributions to place them in more appropriate
				...
				<div align="center" style={{ textAlign: "left" }}>
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							hateful language; (3) your reviews should not contain discriminatory references based on religion, race,
							...
							post any false or misleading statements; and (8) you may not <bdt className="block-component" />
							organize
							<bdt className="statement-end-if-in-editor" /> a campaign encouraging others to post reviews, whether
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							>
								...
								<bdt className="block-component" />
								license
								<bdt className="statement-end-if-in-editor" /> to reproduce, modify, translate, transmit by any means,
								...
								<bdt data-type="body">
									<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
										...
										>
											...
											have with third-party service providers (each such account, a <bdt className="block-component" />
											"Third-Party Account"
											<bdt className="statement-end-if-in-editor" />) by either: (1) providing your Third-Party Account
											login information through the Services; or (2) allowing us to access your{" "}
											<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account, as is permitted under the
											applicable terms and conditions that govern your use of each{" "}
											<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account. You represent and warrant that
											you are entitled to disclose your <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
											Account login information to us and/or grant us access to your{" "}
											<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account, without breach by you of any
											of the terms and conditions that govern your use of the applicable{" "}
											<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account, and without obligating us to
											pay any fees or making us subject to any usage limitations imposed by the third-party service
											provider of the <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account. By granting us
											access to any <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Accounts, you understand
											that (1) we may access, make available, and store (if applicable) any content that you have
											provided to and stored in your <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account
											(the <bdt className="block-component" />
											"Social Network Content"
											<bdt className="statement-end-if-in-editor" />) so that it is available on and through the
											Services via your account, including without limitation any friend lists and (2) we may submit to
											and receive from your <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account
											additional information to the extent you are notified when you link your account with the{" "}
											<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account. Depending on the{" "}
											<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Accounts you choose and subject to the
											privacy settings that you have set in such{" "}
											<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Accounts, personally identifiable
											information that you post to your <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
											Accounts may be available on and through your account on the Services. Please note that if a{" "}
											<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account or associated service becomes
											unavailable or our access to such <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
											...
											<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Accounts at any time. PLEASE NOTE THAT
											YOUR RELATIONSHIP WITH THE THIRD-PARTY SERVICE PROVIDERS ASSOCIATED WITH YOUR THIRD-PARTY ACCOUNTS
											IS GOVERNED SOLELY BY YOUR AGREEMENT(S) WITH SUCH THIRD-PARTY SERVICE PROVIDERS. We make no effort
											to review any Social Network Content for any purpose, including but not limited to, for accuracy,
											...
											<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account and your contacts list stored
											...
											between the Services and your <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account
											...
											through such <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Account, except the
					...
					<div className="MsoNormal" data-custom-class="heading_1" id="thirdparty" style={{ lineHeight: "1.5" }}>
						<strong>
							<span style={{ lineHeight: "24.5333px", fontSize: 19 }}>
								<strong>
									<span
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							<bdt className="statement-end-if-in-editor" />) as well as articles, photographs, text, graphics,
							...
							<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Content are not investigated, monitored, or
							...
							<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Content posted on, available through, or
							...
							<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Content. Inclusion of, linking to, or
							permitting the use or installation of any <span style={{ fontSize: "14.6667px" }}>Third-Party</span>{" "}
							Websites or any <span style={{ fontSize: "14.6667px" }}>Third-Party&nbsp;</span>
							Content does not imply approval or endorsement thereof by us. If you decide to leave the Services and
							access the <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Websites or to use or install any{" "}
							<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Content, you do so at your own risk, and you
							...
							relating to any applications you use or install from the Services. Any purchases you make through{" "}
							<span style={{ fontSize: "14.6667px" }}>Third-Party</span> Websites will be through other websites and
							...
							the products or services offered on <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Websites
							and you shall hold us blameless from any harm caused by your purchase of such products or services.
							Additionally, you shall hold us blameless from any losses sustained by you or harm caused to you relating
							to or resulting in any way from any <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Content or
							any contact with <span style={{ fontSize: "14.6667px" }}>Third-Party</span> Websites.
						</span>
					</div>
					<div className="MsoNormal" style={{ lineHeight: "1.5" }}>
						<br />
					...
					<div className="MsoNormal" data-custom-class="heading_1" id="advertisers" style={{ lineHeight: "1.5" }}>
						<strong>
							<span style={{ lineHeight: "24.5333px", fontSize: 19 }}>
								<strong>
									<span
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
						...
						>
							...
							<strong>
								...
								<span style={{ color: "rgb(0, 58, 250)" }}>
									<bdt
										...
										data-type="question"
									>
										<a href="https://app.melocue.com/privacy-policy" target="_blank" data-custom-class="link">
											https://app.melocue.com/privacy-policy
										</a>
									</bdt>
								</span>
							</strong>
							. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these
							Legal Terms. Please be advised the Services are hosted in <bdt className="block-component" />
							the <bdt className="question">United States</bdt>
							<bdt className="block-component" />
							<bdt className="block-component" />. If you access the Services from any other region of the world with
							...
							<bdt className="block-component" />, then through your continued use of the Services, you are transferring
							your data to{" "}
							<span
								style={{
									fontSize: "11pt",
							...
							<bdt className="block-component" />, and you expressly consent to have your data transferred to and
							processed in{" "}
							<span
								style={{
									fontSize: "11pt",
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						...
						>
							...
							the contact information provided below (a <bdt className="block-component" />
							"Notification"
							<bdt className="statement-end-if-in-editor" />
							). A copy of your Notification will be sent to the person who posted or stored the material addressed in
							the Notification. Please be advised that pursuant to applicable law you may be held liable for damages if
							you make material misrepresentations in a Notification. Thus, if you are not sure that material located on
							or linked to by the Services infringes your copyright, you should consider first contacting an attorney.
						</span>
					</div>
					<div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
						<br />
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						...
						>
							...
							our Services.
							<bdt className="block-component" /> We will not be liable to you or any third party for any modification,
							...
							>
								<bdt data-type="conditional-block">
									...
									>
										...
										<span style={{ fontSize: "14.6667px" }}>,&nbsp;</span>without regard to its conflict of law
										principles.
										<bdt className="block-component" />
									</span>
								</bdt>
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						<span style={{ fontSize: 15 }}>
							...
							<bdt className="statement-end-if-in-editor" />) brought by either you or us (individually, a{" "}
							<bdt className="block-component" />
							"Party" and collectively, the "Parties"
							<bdt className="statement-end-if-in-editor" />
							), the Parties agree to first attempt to negotiate any Dispute (except those Disputes expressly provided
							below) informally for at least <bdt className="question">thirty (30)</bdt> days before initiating
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						...
						<span style={{ fontSize: 15 }}>
							...
							<bdt className="block-component" />
							"AAA"
							<bdt className="statement-end-if-in-editor" />) and, where appropriate, the AAA’s Supplementary Procedures
							for Consumer Related Disputes (<bdt className="block-component" />
							"AAA Consumer Rules"
							<bdt className="statement-end-if-in-editor" />
							...
							Rules and, where appropriate, limited by the AAA Consumer Rules. <bdt className="else-block" />
							...
							<bdt className="block-component" />
							AAA
							<bdt className="else-block" /> rules or applicable law, the arbitration will take place in{" "}
							<bdt className="block-component" />
							<bdt className="question">Lee</bdt>, <bdt className="statement-end-if-in-editor" />
							<bdt className="block-component" />
							<bdt className="question">Florida</bdt>
							<bdt className="statement-end-if-in-editor" />. Except as otherwise provided herein, the Parties may
							litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify,
							vacate, or enter <bdt className="block-component" />
							judgment
							<bdt className="statement-end-if-in-editor" /> on the award entered by the arbitrator.
						</span>
					</div>
					<div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
						<br />
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						...
						<bdt className="block-component" style={{ fontSize: 15 }} /> <bdt className="question">Lee</bdt>
						...
						<bdt className="statement-end-if-in-editor" style={{ fontSize: 15 }} />
						<span style={{ fontSize: 15 }}>
							, and the Parties hereby consent to, and waive all <bdt className="block-component" />
							defenses
							<bdt className="statement-end-if-in-editor" /> of lack of personal jurisdiction, and forum non conveniens
							with respect to venue and jurisdiction in such
							<bdt className="block-component" /> state and federal courts
							<bdt className="statement-end-if-in-editor" />. Application of the United Nations Convention on Contracts
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						...
						<bdt className="block-component" />
						utilize
						<bdt className="statement-end-if-in-editor" /> class action procedures; and (c) there is no right or
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						...
						allegations of theft, piracy, invasion of privacy, or <bdt className="block-component" />
						unauthorized
						<bdt className="statement-end-if-in-editor" /> use; and (c) any claim for injunctive relief. If this
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						...
						>
							...
							ANY <bdt className="block-component" />
							UNAUTHORIZED
							<bdt className="statement-end-if-in-editor" /> ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY AND ALL
							...
							<bdt className="block-component" />
							JUDGMENT
							<bdt className="statement-end-if-in-editor" /> AND EXERCISE CAUTION WHERE APPROPRIATE.
						</span>
					</div>
					<div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
						<br />
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						...
						>
							...
							<span style={{ fontSize: "14.6667px" }}>3</span>) breach of these Legal Terms; (
							<span style={{ fontSize: "14.6667px" }}>4</span>) any breach of your representations and warranties set
							forth in these Legal Terms; (<span style={{ fontSize: "14.6667px" }}>5</span>) your violation of the
							rights of a third party, including but not limited to intellectual property rights; or (
							<span style={{ fontSize: "14.6667px" }}>6</span>) any overt harmful act toward any other user of the
							Services with whom you connected via the Services. Notwithstanding the foregoing, we reserve the right, at
							your expense, to assume the exclusive <bdt className="block-component" />
							defense
							<bdt className="statement-end-if-in-editor" /> and control of any matter for which you are required to
							indemnify us, and you agree to cooperate, at your expense, with our <bdt className="block-component" />
							defense
							<bdt className="statement-end-if-in-editor" /> of such claims. We will use reasonable efforts to notify
							you of any such claim, action, or proceeding which is subject to this indemnification upon becoming aware
							of it.
						</span>
					</div>
					<div className="MsoNormal" style={{ lineHeight: "1.5", textAlign: "left" }}>
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						...
						>
							...
							defenses
							<bdt className="statement-end-if-in-editor" /> you may have based on the electronic form of these Legal
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						<span style={{ fontSize: 15 }}>
							<span style={{ color: "rgb(89, 89, 89)" }}>
								<bdt className="question">
									<strong>JC&X SOLUTIONS LLC</strong>
								</bdt>
								<strong>
									<bdt className="block-component" />
								</strong>
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						<span style={{ fontSize: 15 }}>
							<strong>
								<span style={{ color: "rgb(89, 89, 89)" }}>
									<bdt className="question">Cape Coral</bdt>
									<bdt className="block-component" />
									<bdt className="block-component" />, <bdt className="question">FL</bdt>
									<bdt className="statement-end-if-in-editor" />
									<bdt className="block-component" />
							...
							<strong>
								<strong>
									...
									>
										<strong>
											<bdt className="block-component" />
											Phone: <bdt className="question">239 878 7268</bdt>
											<bdt className="statement-end-if-in-editor" />
										</strong>
									</span>
								</strong>
					...
					<div className="MsoNormal" data-custom-class="body_text" style={{ lineHeight: "1.5", textAlign: "left" }}>
						<strong>
							...
							>
								<strong>
									<bdt className="question">jcnxsolutions@gmail.com</bdt>
								</strong>
							</span>
						</strong>
					</div>
