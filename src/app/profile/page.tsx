...
export default function ProfilePage() {
    return (
        <div>
            <div>
                <img className="h-32 w-full object-cover lg:h-48" src={page.backgroundImage} alt="" />
            </div>
            <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                <div className="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                    <div className="flex">
                        <img className="h-24 w-24 rounded-full ring-4 ring-white sm:h-32 sm:w-32" src={page.avatar} alt="" />
                    </div>
